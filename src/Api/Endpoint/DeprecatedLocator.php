...
class DeprecatedLocator extends \ShipStream\Ups\Api\Runtime\Client\BaseEndpoint implements \ShipStream\Ups\Api\Runtime\Client\Endpoint
{
    ...
    * }
    */
    public function __construct(string $deprecatedVersion, string $reqOption, \ShipStream\Ups\Api\Model\LOCATORRequestWrapper $requestBody, array $queryParameters = array(), array $headerParameters = array())
    {
    ...
    {
        return str_replace(array('{deprecatedVersion}', '{reqOption}'), array($this->deprecatedVersion, $this->reqOption), '/locations/{deprecatedVersion}/search/availabilities/{reqOption}');
    }
    ...
    protected function getQueryOptionsResolver() : \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(array('Locale'));
        $optionsResolver->setRequired(array());
        $optionsResolver->setDefaults(array('Locale' => 'en_US'));
