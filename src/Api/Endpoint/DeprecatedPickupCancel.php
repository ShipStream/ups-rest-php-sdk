...
class DeprecatedPickupCancel extends \ShipStream\Ups\Api\Runtime\Client\BaseEndpoint implements \ShipStream\Ups\Api\Runtime\Client\Endpoint
{
    ...
    * }
    */
    public function __construct(string $cancelBy, string $deprecatedVersion, array $headerParameters = array())
    {
    ...
    {
        return str_replace(array('{CancelBy}', '{deprecatedVersion}'), array($this->CancelBy, $this->deprecatedVersion), '/shipments/{deprecatedVersion}/pickup/{CancelBy}');
    }
