...
class DeprecatedVoidShipment extends \ShipStream\Ups\Api\Runtime\Client\BaseEndpoint implements \ShipStream\Ups\Api\Runtime\Client\Endpoint
{
    ...
    * }
    */
    public function __construct(string $deprecatedVersion, string $shipmentidentificationnumber, array $queryParameters = array(), array $headerParameters = array())
    {
    ...
    {
        return str_replace(array('{deprecatedVersion}', '{shipmentidentificationnumber}'), array($this->deprecatedVersion, $this->shipmentidentificationnumber), '/shipments/{deprecatedVersion}/void/cancel/{shipmentidentificationnumber}');
    }
