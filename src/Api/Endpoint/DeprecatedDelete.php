...
class DeprecatedDelete extends \ShipStream\Ups\Api\Runtime\Client\BaseEndpoint implements \ShipStream\Ups\Api\Runtime\Client\Endpoint
{
    ...
    * }
    */
    public function __construct(string $deprecatedVersion, array $headerParameters = array())
    {
    ...
    {
        return str_replace(array('{deprecatedVersion}'), array($this->deprecatedVersion), '/paperlessdocuments/{deprecatedVersion}/DocumentId/ShipperNumber');
    }
