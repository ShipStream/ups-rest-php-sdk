...
class RateShipmentServiceOptionsRestrictedArticlesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\RateShipmentServiceOptionsRestrictedArticles::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\RateShipmentServiceOptionsRestrictedArticles::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('eCigarettesIndicator') && null !== $data->getECigarettesIndicator()) {
            $dataArray['ECigarettesIndicator'] = $data->getECigarettesIndicator();
        }
        if ($data->isInitialized('hempCBDIndicator') && null !== $data->getHempCBDIndicator()) {
            $dataArray['HempCBDIndicator'] = $data->getHempCBDIndicator();
        }
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
    ...
    {
        return [\ShipStream\Ups\Api\Model\RateShipmentServiceOptionsRestrictedArticles::class => false];
    }
}