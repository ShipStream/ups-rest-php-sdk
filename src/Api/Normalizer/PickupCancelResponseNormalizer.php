...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupCancelResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \ShipStream\Ups\Api\Model\PickupCancelResponse::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\PickupCancelResponse::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('Response', $data)) {
                $object->setResponse($this->denormalizer->denormalize($data['Response'], \ShipStream\Ups\Api\Model\PickupCancelResponseResponse::class, 'json', $context));
                unset($data['Response']);
            }
            ...
            if (\array_key_exists('GWNStatus', $data)) {
                $object->setGWNStatus($this->denormalizer->denormalize($data['GWNStatus'], \ShipStream\Ups\Api\Model\PickupCancelResponseGWNStatus::class, 'json', $context));
        ...
        {
            return [\ShipStream\Ups\Api\Model\PickupCancelResponse::class => false];
        }
    }
} else {
    class PickupCancelResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
