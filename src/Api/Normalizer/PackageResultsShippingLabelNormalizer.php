...
class PackageResultsShippingLabelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\PackageResultsShippingLabel::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\PackageResultsShippingLabel::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('ImageFormat', $data)) {
            $object->setImageFormat($this->denormalizer->denormalize($data['ImageFormat'], \ShipStream\Ups\Api\Model\ShippingLabelImageFormat::class, 'json', $context));
    ...
    {
        $dataArray = [];
        $dataArray['ImageFormat'] = $this->normalizer->normalize($data->getImageFormat(), 'json', $context);
        $dataArray['GraphicImage'] = $data->getGraphicImage();
        if ($data->isInitialized('graphicImagePart') && null !== $data->getGraphicImagePart()) {
            $values = [];
            foreach ($data->getGraphicImagePart() as $value) {
                $values[] = $value;
            }
            $dataArray['GraphicImagePart'] = $values;
        }
    ...
    {
        return [\ShipStream\Ups\Api\Model\PackageResultsShippingLabel::class => false];
    }
}