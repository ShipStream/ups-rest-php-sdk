...
class ShipmentFreightShipmentInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('freightDensityInfo') && null !== $data->getFreightDensityInfo()) {
            $dataArray['FreightDensityInfo'] = $this->normalizer->normalize($data->getFreightDensityInfo(), 'json', $context);
        }
