...
class EMailInformationEMailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\EMailInformationEMail::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\EMailInformationEMail::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('eMailText') && null !== $data->getEMailText()) {
            $dataArray['EMailText'] = $data->getEMailText();
        }
    ...
    {
        return [\ShipStream\Ups\Api\Model\EMailInformationEMail::class => false];
    }
}