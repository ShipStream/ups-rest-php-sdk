...
class OriginAddressOriginSearchCriteriaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\OriginAddressOriginSearchCriteria::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\OriginAddressOriginSearchCriteria::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['DistanceUnitOfMeasure'] = $data->getDistanceUnitOfMeasure();
        if ($data->isInitialized('maximumLocation') && null !== $data->getMaximumLocation()) {
            $dataArray['MaximumLocation'] = $data->getMaximumLocation();
        }
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
    ...
    {
        return [\ShipStream\Ups\Api\Model\OriginAddressOriginSearchCriteria::class => false];
    }
}