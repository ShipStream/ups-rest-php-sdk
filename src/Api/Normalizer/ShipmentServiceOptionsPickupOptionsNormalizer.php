...
class ShipmentServiceOptionsPickupOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('liftGateAtPickupIndicator') && null !== $data->getLiftGateAtPickupIndicator()) {
            $dataArray['LiftGateAtPickupIndicator'] = $data->getLiftGateAtPickupIndicator();
        }
