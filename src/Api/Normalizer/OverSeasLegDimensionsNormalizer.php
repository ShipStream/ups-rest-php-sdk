...
class OverSeasLegDimensionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\OverSeasLegDimensions::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\OverSeasLegDimensions::class;
    }
    ...
    {
        return [\ShipStream\Ups\Api\Model\OverSeasLegDimensions::class => false];
    }
}