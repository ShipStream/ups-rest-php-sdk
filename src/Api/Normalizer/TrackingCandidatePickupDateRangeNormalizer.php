...
class TrackingCandidatePickupDateRangeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\TrackingCandidatePickupDateRange::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\TrackingCandidatePickupDateRange::class;
    }
    ...
    {
        $dataArray = [];
        $dataArray['BeginDate'] = $data->getBeginDate();
    ...
    {
        return [\ShipStream\Ups\Api\Model\TrackingCandidatePickupDateRange::class => false];
    }
}