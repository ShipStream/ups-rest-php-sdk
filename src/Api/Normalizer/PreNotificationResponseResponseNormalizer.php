...
class PreNotificationResponseResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\PreNotificationResponseResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\PreNotificationResponseResponse::class;
    }
    ...
    {
        return [\ShipStream\Ups\Api\Model\PreNotificationResponseResponse::class => false];
    }
}