...
class PaymentDetailsShipmentChargeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\PaymentDetailsShipmentCharge::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\PaymentDetailsShipmentCharge::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('BillShipper', $data)) {
            $object->setBillShipper($this->denormalizer->denormalize($data['BillShipper'], \ShipStream\Ups\Api\Model\RateShipmentChargeBillShipper::class, 'json', $context));
        ...
        if (\array_key_exists('BillThirdParty', $data)) {
            $object->setBillThirdParty($this->denormalizer->denormalize($data['BillThirdParty'], \ShipStream\Ups\Api\Model\RateShipmentChargeBillThirdParty::class, 'json', $context));
    ...
    {
        return [\ShipStream\Ups\Api\Model\PaymentDetailsShipmentCharge::class => false];
    }
}