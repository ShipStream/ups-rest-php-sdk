...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentAlternateDeliveryAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('UPSAccessPointID', $data) && $data['UPSAccessPointID'] !== null) {
                $object->setUPSAccessPointID($data['UPSAccessPointID']);
                unset($data['UPSAccessPointID']);
            }
            elseif (\array_key_exists('UPSAccessPointID', $data) && $data['UPSAccessPointID'] === null) {
                $object->setUPSAccessPointID(null);
            }
        ...
        {
            return ['ShipStream\\Ups\\Api\\Model\\ShipmentAlternateDeliveryAddress' => false];
        }
    }
} else {
    class ShipmentAlternateDeliveryAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
