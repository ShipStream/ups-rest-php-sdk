...
class ShipmentResultsTimeInTransitNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\ShipmentResultsTimeInTransit::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\ShipmentResultsTimeInTransit::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('daysInTransit') && null !== $data->getDaysInTransit()) {
    ...
    {
        return [\ShipStream\Ups\Api\Model\ShipmentResultsTimeInTransit::class => false];
    }
}