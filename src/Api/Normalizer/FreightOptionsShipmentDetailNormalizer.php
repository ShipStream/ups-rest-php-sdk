...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FreightOptionsShipmentDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \ShipStream\Ups\Api\Model\FreightOptionsShipmentDetail::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\FreightOptionsShipmentDetail::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('PalletInformation', $data)) {
                $object->setPalletInformation($this->denormalizer->denormalize($data['PalletInformation'], \ShipStream\Ups\Api\Model\ShipmentDetailPalletInformation::class, 'json', $context));
        ...
        {
            return [\ShipStream\Ups\Api\Model\FreightOptionsShipmentDetail::class => false];
        }
    }
} else {
    class FreightOptionsShipmentDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
