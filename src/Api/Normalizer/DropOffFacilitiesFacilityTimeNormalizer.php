...
class DropOffFacilitiesFacilityTimeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\DropOffFacilitiesFacilityTime::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\DropOffFacilitiesFacilityTime::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('DayOfWeek', $data)) {
            ...
            foreach ($data['DayOfWeek'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \ShipStream\Ups\Api\Model\FacilityTimeDayOfWeek::class, 'json', $context);
            }
    ...
    {
        return [\ShipStream\Ups\Api\Model\DropOffFacilitiesFacilityTime::class => false];
    }
}