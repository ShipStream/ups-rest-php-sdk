...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AcceptanceAuditPreCheckResponseResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('AlertDetail', $data) && $data['AlertDetail'] !== null) {
                $values_1 = [];
            ...
            elseif (\array_key_exists('AlertDetail', $data) && $data['AlertDetail'] === null) {
                $object->setAlertDetail(null);
            }
        ...
        {
            return ['ShipStream\\Ups\\Api\\Model\\AcceptanceAuditPreCheckResponseResponse' => false];
        }
    }
} else {
    class AcceptanceAuditPreCheckResponseResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
