...
class FreightShipPOMPickupNotificationsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\FreightShipPOMPickupNotifications::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\FreightShipPOMPickupNotifications::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('EMailNotification', $data)) {
            $object->setEMailNotification($this->denormalizer->denormalize($data['EMailNotification'], \ShipStream\Ups\Api\Model\FreightShipPickupNotificationsEMailNotification::class, 'json', $context));
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['EMailNotification'] = $this->normalizer->normalize($data->getEMailNotification(), 'json', $context);
    ...
    {
        return [\ShipStream\Ups\Api\Model\FreightShipPOMPickupNotifications::class => false];
    }
}