...
class AvailableLocationAttributesPickUpPickUpDetailsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\AvailableLocationAttributesPickUpPickUpDetails::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\AvailableLocationAttributesPickUpPickUpDetails::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['NoPickUpIndicator'] = $data->getNoPickUpIndicator();
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
            }
    ...
    {
        return [\ShipStream\Ups\Api\Model\AvailableLocationAttributesPickUpPickUpDetails::class => false];
    }
}