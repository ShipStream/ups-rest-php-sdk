...
class RateAlternateDeliveryAddressAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\RateAlternateDeliveryAddressAddress::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\RateAlternateDeliveryAddressAddress::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('residentialAddressIndicator') && null !== $data->getResidentialAddressIndicator()) {
            $dataArray['ResidentialAddressIndicator'] = $data->getResidentialAddressIndicator();
        }
        if ($data->isInitialized('pOBoxIndicator') && null !== $data->getPOBoxIndicator()) {
            $dataArray['POBoxIndicator'] = $data->getPOBoxIndicator();
        }
        foreach ($data as $key => $value_1) {
            if (preg_match('/.*/', (string) $key)) {
    ...
    {
        return [\ShipStream\Ups\Api\Model\RateAlternateDeliveryAddressAddress::class => false];
    }
}