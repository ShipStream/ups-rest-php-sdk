...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RateAlternateDeliveryAddressAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('POBoxIndicator', $data) && $data['POBoxIndicator'] !== null) {
                $object->setPOBoxIndicator($data['POBoxIndicator']);
                unset($data['POBoxIndicator']);
            }
            elseif (\array_key_exists('POBoxIndicator', $data) && $data['POBoxIndicator'] === null) {
                $object->setPOBoxIndicator(null);
            }
        ...
        {
            return ['ShipStream\\Ups\\Api\\Model\\RateAlternateDeliveryAddressAddress' => false];
        }
    }
} else {
    class RateAlternateDeliveryAddressAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
