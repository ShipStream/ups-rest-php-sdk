...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupCreationRequestShipperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \ShipStream\Ups\Api\Model\PickupCreationRequestShipper::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\PickupCreationRequestShipper::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('Account', $data)) {
                $object->setAccount($this->denormalizer->denormalize($data['Account'], \ShipStream\Ups\Api\Model\ShipperAccount::class, 'json', $context));
                unset($data['Account']);
            }
            if (\array_key_exists('ChargeCard', $data)) {
                $object->setChargeCard($this->denormalizer->denormalize($data['ChargeCard'], \ShipStream\Ups\Api\Model\ShipperChargeCard::class, 'json', $context));
        ...
        {
            return [\ShipStream\Ups\Api\Model\PickupCreationRequestShipper::class => false];
        }
    }
} else {
    class PickupCreationRequestShipperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
