...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class QUANTUMVIEWResponseWrapperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('QuantumViewResponse', $data) && $data['QuantumViewResponse'] !== null) {
            ...
            elseif (\array_key_exists('QuantumViewResponse', $data) && $data['QuantumViewResponse'] === null) {
                $object->setQuantumViewResponse(null);
            }
