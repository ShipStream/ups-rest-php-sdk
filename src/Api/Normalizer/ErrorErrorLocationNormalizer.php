...
class ErrorErrorLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('errorLocationElementName') && null !== $data->getErrorLocationElementName()) {
            $dataArray['ErrorLocationElementName'] = $data->getErrorLocationElementName();
        }
        if ($data->isInitialized('errorLocationAttributeName') && null !== $data->getErrorLocationAttributeName()) {
