...
class ExceptionUpdatedAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\ExceptionUpdatedAddress::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\ExceptionUpdatedAddress::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('AddressExtendedInformation', $data)) {
            ...
            foreach ($data['AddressExtendedInformation'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \ShipStream\Ups\Api\Model\UpdatedAddressAddressExtendedInformation::class, 'json', $context);
            }
    ...
    {
        return [\ShipStream\Ups\Api\Model\ExceptionUpdatedAddress::class => false];
    }
}