...
class PickupGetServiceCenterFacilitiesRequestOriginAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\PickupGetServiceCenterFacilitiesRequestOriginAddress::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\PickupGetServiceCenterFacilitiesRequestOriginAddress::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('OriginSearchCriteria', $data)) {
            $object->setOriginSearchCriteria($this->denormalizer->denormalize($data['OriginSearchCriteria'], \ShipStream\Ups\Api\Model\OriginAddressOriginSearchCriteria::class, 'json', $context));
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('originSearchCriteria') && null !== $data->getOriginSearchCriteria()) {
            $dataArray['OriginSearchCriteria'] = $this->normalizer->normalize($data->getOriginSearchCriteria(), 'json', $context);
        }
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
    ...
    {
        return [\ShipStream\Ups\Api\Model\PickupGetServiceCenterFacilitiesRequestOriginAddress::class => false];
    }
}