...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AvailableLocationAttributesOptionCodeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \ShipStream\Ups\Api\Model\AvailableLocationAttributesOptionCode::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\AvailableLocationAttributesOptionCode::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('TransportationPickUpSchedule', $data)) {
                $object->setTransportationPickUpSchedule($this->denormalizer->denormalize($data['TransportationPickUpSchedule'], \ShipStream\Ups\Api\Model\AvailableLocationAttributesOptionCodeTransportationPickUpSchedule::class, 'json', $context));
        ...
        {
            return [\ShipStream\Ups\Api\Model\AvailableLocationAttributesOptionCode::class => false];
        }
    }
} else {
    class AvailableLocationAttributesOptionCodeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
