...
class LabelRecoveryRequest extends \ArrayObject
{
     ...
     *
     * @var LabelRecoveryRequestRequest|null
     */
    protected $request;
    /**
     ...
     *
     * @var LabelRecoveryRequestLabelSpecification|null
     */
    ...
    *
    * @var LabelRecoveryRequestTranslate|null
    */
    protected $translate;
    /**
     * Container for the Label Delivery accessorial. One Label Delivery per shipment.
     *
     * @var LabelRecoveryRequestLabelDelivery|null
     */
    ...
    */
     ...
     *
     * @var LabelRecoveryRequestReferenceValues|null
     */
    ...
    *
    * @var LabelRecoveryRequestUPSPremiumCareForm|null
    */
    protected $uPSPremiumCareForm;
    /**
     * Request Container.  N/A
     *
     * @return LabelRecoveryRequestRequest|null
     */
     ...
     * Request Container.  N/A
     *
     * @param LabelRecoveryRequestRequest|null $request
     *
     * @return self
     */
     ...
     * Container that is used to define the properties required by the user to print and/ or display the UPS shipping label.  Required for the shipment without return service, or shipment with PRL return service.
     *
     * @return LabelRecoveryRequestLabelSpecification|null
     */
     ...
     * Container that is used to define the properties required by the user to print and/ or display the UPS shipping label.  Required for the shipment without return service, or shipment with PRL return service.
     *
     * @param LabelRecoveryRequestLabelSpecification|null $labelSpecification
     *
     * @return self
     */
    ...
    * Translate container allows the user to specify the language he/she would like a specific portion of response to return. 
    ...
    If shipping from some other country or territory, the language defaults to Queens English.
    *
    * @return LabelRecoveryRequestTranslate|null
    */
    ...
    * Translate container allows the user to specify the language he/she would like a specific portion of response to return. 
    ...
    If shipping from some other country or territory, the language defaults to Queens English.
    *
    * @param LabelRecoveryRequestTranslate|null $translate
    *
    * @return self
    */
     ...
     * Container for the Label Delivery accessorial. One Label Delivery per shipment.
     *
     * @return LabelRecoveryRequestLabelDelivery|null
     */
     ...
     * Container for the Label Delivery accessorial. One Label Delivery per shipment.
     *
     * @param LabelRecoveryRequestLabelDelivery|null $labelDelivery
     *
     * @return self
     */
    ...
    */
     ...
     * Container that holds reference number and shipper number  If tracking number is not present use reference Number
     *
     * @return LabelRecoveryRequestReferenceValues|null
     */
     ...
     * Container that holds reference number and shipper number  If tracking number is not present use reference Number
     *
     * @param LabelRecoveryRequestReferenceValues|null $referenceValues
     *
     * @return self
     */
    ...
    * UPS Premium Care Form container.  Default is PDF when container is not provided. 
     Valid only for Canada to Canada movements. UPS Premium Care Form will be returned in  both US English and Canadian French language.
    *
    * @return LabelRecoveryRequestUPSPremiumCareForm|null
    */
    ...
    * UPS Premium Care Form container.  Default is PDF when container is not provided. 
     Valid only for Canada to Canada movements. UPS Premium Care Form will be returned in  both US English and Canadian French language.
    *
    * @param LabelRecoveryRequestUPSPremiumCareForm|null $uPSPremiumCareForm
    *
    * @return self
    */
